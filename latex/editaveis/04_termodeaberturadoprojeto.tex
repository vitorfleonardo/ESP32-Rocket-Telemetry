...
%\hline
%RF2 & A plataforma de lançamento deve ajustar o ângulo de disparo entre 0° e 90° com resolução de 0,1°, usando atuador eletromecânico controlado por malha fechada. \\
%\hline
% RF3 & O dispositivo de segurança deve travar o disparo se qualquer pessoa ou objeto for detectado a menos de 5\,m do cano de lançamento, via sensor ultrassônico ou LiDAR. \\
\hline
...
%\hline
%RC2 & Todos os sensores e atuadores devem ser de fornecedores com garantia mínima de 1 ano. \\
\hline
